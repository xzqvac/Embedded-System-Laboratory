...
stopwatch_next:
	...
	ld r16, Z
	inc r16
	;jmp increment_display
	cpi r16, 10  								; check if counter achieved 4 changes of state
...
stopwatch_next_less_than_four:
	...
	adc r31, r16								; add with carry r16 to r31
	lpm r17, Z									; load ONE byte from reg_Z to r17
