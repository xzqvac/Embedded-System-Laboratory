...
stopwatch_next_less_than_four:
	st Z, r16									; in r16 remember how many states are passed (< 4)

	; Load digit pattern (from program memory)	;r17 = r30 + r31  r30 = (xxxx) + 1  r31 = (yyyy) + 0 
	load_register_Z patterns
	add r30, r16								; add without carry r16 to r30 ;r16 = 0x01 r30= 0000 0001
	ldi r16, 0x00								; load 0x00 to r16 ; r16 = 0 
	adc r31, r16								; add with carry r16 to r31 ; r31 = 0000 0000
	lpm r17, Z									; load byte from reg_Z to r17 ; r17 = 0xC0....
...
patterns:
	.byte 0xC0, 0xF9, 0xA4, 0xB0 ; zapis liczby xxxx yyyy
